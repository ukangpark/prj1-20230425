		...
		<div class="row justify-content-center">
			<div class="col-12 col-md-8 col-lg-6">
				...
				<form method="post" enctype="multipart/form-data">
					...
					<div class="mb-3">
						<label for="titleInput" class="form-label">제목</label> <input type="text" class="form-control" name="title" value="${board.title }" />
					</div>
					...
					<div class="mb-3">
						<c:forEach items="${board.fileName }" var="fileName" varStatus="status">
							<div class="form-check form-switch">
								...
								<label class="form-check-label" for="removeCheckBox${status.index}"><i class="fa-solid fa-trash-can"></i></label>
							</div>
							<div>
